#rm(list=ls())
setwd("/Users/edwardsb/LocalRepos/gustavo_evaluation_Rcode/testing_purturbed")
#host, score, rank
library(pROC)
library(ggplot2)
...
for (k in 1:length(topics)){
  ...
  for(j in 1:replicates){
    ...
    skip = all_content[-c(1:1)]
    # If not skipping .......df = read.csv(textConnection(all_content), header = F, stringsAsFactors = FALSE)
