...
listFiles <-list(f20,f30)         #list(f5,f10,f15,f20,f30,f50,f100)

replicates <- length(f20)                #replicates <- length(f5)

#Total rows: normal + abnormal
totalRows <- 174361844
topics <- c(20, 30)         #c(5,10,15,20,30,50,100)
...
for (k in 1:length(topics)){
  ...
  aucDF$replicates <- 2       #aucDF$replicates <- 1:10
